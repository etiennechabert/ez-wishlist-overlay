...
//!
//! Loads an image via [`image`] (the same decoder as the rest of the app),
//! converts to BGRA8, hands it to `OcrEngine` as a `SoftwareBitmap`, and
//! returns word-level boxes in pixel coordinates.
//!
